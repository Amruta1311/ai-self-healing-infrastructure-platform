...
# Create column layout for dynamic updates
col1, col2, col3, col4 = st.columns(4)

metrics_placeholder = col1.empty()
infra_placeholder = col2.empty()
diagnosis_placeholder = col3.empty()
business_placeholder = col4.empty()

action_placeholder = col3.empty()  # Action shown below diagnosis

# Placeholder for incident table below the columns
...
if run:
    ...
    while True:
        ...
        with action_placeholder.container():
            st.success(f"Remediation Action: {action}")
        ...
        # Update incident table dynamically
        rows = store.fetch_recent()
        df = pd.DataFrame(rows, columns=columns)
